...
for i in range(len(datasets)):
    print("--------", f"DATASET: {datasets[i]}({dataseturls[i]})", sep="\n")
    ...
    clf = RuleListClassifier(
        max_iter=50000, n_chains=3, class1label=data_class1_labels[i], verbose=False
    )
