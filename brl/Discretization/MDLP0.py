# https://github.com/navicto/Discretization-MDLPC/blob/master/MDLP.py
...
from brl.Discretization.Entropy0 import cut_point_information_gain_numpy, entropy_numpy
